<template>
    <div class="modal fade show" id="create-category-form" tabindex="-1" role="dialog" aria-labelledby="create-user-form" aria-modal="true">
...
<script>
    ...
    export default {
        name: "CreateArticleCategoryComponent",
        props: [
            'request_url', 'title'
        ],
        data() {
            ...
            create: function() {
                ...
                axios({ method: "POST", url: ctx.request_url, data: formData }).then(function (response) {
                    ...
                    if (data.meta.error) {
                        ...
                        swal({
                            title: 'Success',
                            text: 'You have successfully updated a article category.',
                            type: 'success',
