        ...
        <div id="index-table" class="table-responsive">
            <table class="table align-items-center table-flush">
                ...
                <tr v-for="(item) in data">
                    ...
                    <update-article-category-component :request_url="request_url" :data.sync="item" :key="item.id" v-on:refresh-page="retrieve" ></update-article-category-component>
                </tr>
                </tbody>
            </table>
        </div>
...
<script>
    ...
    import CreateArticleCategoryComponent from "./CreateArticleCategoryComponent";

    export default {
        name: "IndexArticleCategoryComponent",
        components: {
            VuePagination,
            CreateArticleCategoryComponent
        },
        props: [
