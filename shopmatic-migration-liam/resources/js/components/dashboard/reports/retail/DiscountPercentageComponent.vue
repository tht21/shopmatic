    ...
    <div class="col-md-4">
        <div v-show="custom" class="card card-stats mb-4">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0">Discount Percentage</h5>
                        <span class="h2 font-weight-bold mb-0">{{ calculateDiscountPercentage }}</span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <span class="h1 font-weight-bold mb-0">{{ calculateDiscountPercentage }}</span>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        extends: Line,
        props: ['labels', 'discount', 'custom', 'groups', 'type'],
        filters : {
