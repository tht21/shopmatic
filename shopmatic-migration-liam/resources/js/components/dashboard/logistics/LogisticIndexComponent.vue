<template>
    <div class="card">
        <div class="card-header border-0">
            <h3 class="mb-0">Logistic <button class="btn btn-sm btn-info ml-3" @click="retrieve"><i class="fa fa-sync-alt"></i></button></h3>
        </div>
        <div id="index-table" class="table-responsive">
            <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                <tr v-for="item in data" class="cursor-pointer">
...
<script>
    export default {
        name: "LogisticIndexComponent",
        data() {
           return {
               data: [],
               request_url: '/web/logistics',
               retrieving: false,
               pagination: {
                   current_page: 1,
                   from: 1,
