<template>
    <span>
        ...
        <b-modal id="order-fulfillment-modal" ref="order-fulfillment-modal" size="lg"
            ...
            <template v-slot:modal-footer="{ ok, cancel }">
                ...
                <b-button variant="primary" class="ml-auto" @click="confirmFulfillment">Update</b-button>
            </template>
        </b-modal>
    </span>
</template>
...
<script>
    export default {
        name: "WoocommerceBulkFulfillmentOrderComponent",
        ...
        methods: {
            ...
            closeFulfillment() {
                ...
                this.$refs['order-fulfillment-modal'].hide();
            },
            openFulfillmentModel() {
                ...
                this.$refs['order-fulfillment-modal'].show();
            },
            confirmFulfillment() {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        Object.values(this.selected_orders[this.status]).forEach((order) => {
                            ...
                            promisedEvents.push(axios.post('/web/orders/' + order.id + '/woocommerce/fulfillment', {
