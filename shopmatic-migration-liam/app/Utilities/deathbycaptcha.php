...
abstract class DeathByCaptcha_Client
{
     ...
     * @throws DeathByCaptcha_InvalidCaptchaException
     * @uses DeathByCaptcha_Client::get_captcha()
...
class DeathByCaptcha_HttpClient extends DeathByCaptcha_Client
{
     ...
     * @throws DeathByCaptcha_RuntimeException
     */
     ...
     * @param array $extra
     * @return array|null
     * @throws DeathByCaptcha_AccessDeniedException
     * @throws DeathByCaptcha_IOException
     * @throws DeathByCaptcha_InvalidCaptchaException
     * @throws DeathByCaptcha_RuntimeException When failed to save CAPTCHA image to a temporary file
     * @throws DeathByCaptcha_ServerException
        ...
        try {
            ...
            if (!empty($response['error'])) {
                switch ($response['error']) {
                    ...
                    default:
                        throw new DeathByCaptcha_ServerException(
                            'API server error occurred: ' . $response['error']
                        );
                }
            } else {
                return $response;
